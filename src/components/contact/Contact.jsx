  ...
  return (
    ...
    >
      <motion.div className="textContainer" variants={variants}>
        <motion.span variants={variants} className="eyebrow">Vamos trabalhar juntos</motion.span>
        <motion.h1 variants={variants}>Entre em<br />contato</motion.h1>
        <motion.div className="contactLinks" variants={variants}>
